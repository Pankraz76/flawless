...
* BREAKING CHANGE: Plugin portal ID is still `com.diffplug.gradle.spotless`, but Maven coordinate has changed to `com.opencohesion.flawless:flawless-plugin-gradle`.
