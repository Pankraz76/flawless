...
class ForbidModuleImportsStepTest extends MavenIntegrationHarness {
	...
	void testForbidModuleImports() throws Exception {
		...
		selfie.toBe("""
				Failed to execute goal com.diffplug.spotless:flawless-maven-plugin:VERSION:apply (default-cli) on project flawless-maven-plugin-tests: There were 2 lint error(s), they must be fixed or suppressed.
